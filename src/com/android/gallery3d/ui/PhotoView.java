...
public class PhotoView extends GLView {
    ...
    private final Texture mDrmIcon;
    private int mVideoPlayIconSize;
    ...
    public PhotoView(AbstractGalleryActivity activity) {
        ...
        mPlaceholderColor = mContext.getColor(R.color.photo_placeholder);
        ...
        mUndoBar.setOnClickListener(view -> {
...
//            }
    ...
    private float getScrollScale(float scrollProgress) {
        ...
        return (1 - interpolatedProgress) + interpolatedProgress * TRANSITION_SCALE_FACTOR;
    }
