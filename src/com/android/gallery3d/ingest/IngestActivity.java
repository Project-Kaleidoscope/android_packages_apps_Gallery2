...
public class IngestActivity extends Activity implements
    ...
    private final MultiChoiceModeListener mMultiChoiceModeListener = new MultiChoiceModeListener() {
    ...
    private final PositionMappingCheckBroker mPositionMappingCheckBroker =
    ...
    private final DataSetObserver mMasterObserver = new DataSetObserver() {
        @Override
    ...
    private final ProgressState mProgressState = new ProgressState();
    ...
    private final ServiceConnection mHelperServiceConnection = new ServiceConnection() {
        @Override
