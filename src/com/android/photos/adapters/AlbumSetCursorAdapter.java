...
public class AlbumSetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View v, Context context, Cursor cursor) {
        TextView titleTextView = v.findViewById(R.id.album_set_item_title);
        titleTextView.setText(cursor.getString(AlbumSetLoader.INDEX_TITLE));

        TextView countTextView = v.findViewById(R.id.album_set_item_count);
        int count = cursor.getInt(AlbumSetLoader.INDEX_COUNT);
        countTextView.setText(context.getResources().getQuantityString(R.plurals.number_of_photos, count, count));
